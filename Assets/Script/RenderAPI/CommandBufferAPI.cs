...
public class CommandBufferAPI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //buffer1.ClearRenderTarget(true, true, Color.clear, 1);
        buffer1.DrawMesh(mesh, Matrix4x4.identity, MRT);
        ...
        //buffer2.ClearRenderTarget(true, true, Color.clear, 1);
        buffer2.DrawMesh(mesh, Matrix4x4.identity, MRT);
